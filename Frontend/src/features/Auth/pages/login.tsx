...
const LoginPage = () => {
  return (
    <main className="relative flex min-h-screen w-full overflow-hidden bg-[#f8f2ed] text-[#101b3d]">
      ...
      <div className="absolute -bottom-20 -left-16 hidden h-[260px] w-[260px] rounded-full bg-green-600/25 blur-2xl lg:block" />
      <div className="absolute bottom-10 left-8 hidden h-[170px] w-[40px] rotate-[-45deg] rounded-full bg-green-700/35 blur-md lg:block" />
      <div className="absolute bottom-16 left-20 hidden h-[180px] w-[38px] rotate-[-70deg] rounded-full bg-green-600/35 blur-md lg:block" />
      ...
      <section className="relative z-10 mx-auto grid min-h-screen w-full max-w-[1360px] grid-cols-1 items-center gap-8 px-5 py-5 lg:grid-cols-[0.95fr_0.9fr] lg:px-10 lg:py-6 xl:gap-10">
        ...
        <div className="flex min-h-screen items-center justify-center lg:min-h-0">
          <div className="w-full max-w-[520px] rounded-[30px] border border-white/70 bg-white/72 px-7 py-8 shadow-[0_30px_80px_rgba(30,60,80,0.16)] backdrop-blur-2xl sm:px-10 md:px-12 lg:min-h-[650px] lg:px-12">
